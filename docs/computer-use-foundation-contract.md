...
| Modal / multi-window routing | PASS | app→frontmost sheet、exact secondary window、direct AXWindow→AXSheet/AXDrawer frame matching；5 轮 open/close/button/scroll oracle，全程目标未前台 | 扩展到更多真实应用的 modal/window 样本 |
