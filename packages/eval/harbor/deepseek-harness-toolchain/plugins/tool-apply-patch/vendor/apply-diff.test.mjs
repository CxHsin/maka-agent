// The upstream test suite for the vendored V4A applier, carried verbatim.
//
// Source:  packages/agents-core/test/utils/applyDiff.test.ts
//          https://github.com/openai/openai-agents-js
//          commit e2cbca883dfccae90791c1e9237c15ef897a85d2
// License: MIT, Copyright (c) 2025 OpenAI (see ../../NOTICE)
//
// This is what makes the vendored copy checkable rather than merely attributed:
// apply-diff.mjs is a mechanical tsc emit, and these 38 cases are the evidence
// that the emit behaves as the TypeScript source did. Re-vendoring must bring
// this file along from the same commit.
//
// Only the two import lines changed. Upstream runs on Vitest; the four-line
// shim below maps the two matchers this suite uses onto node:test, so the cases
// themselves stay byte-identical and a re-vendor is a clean overwrite.

import { describe, it } from 'node:test';
import { strict as assert } from 'node:assert';
import { applyDiff } from './apply-diff.mjs';
